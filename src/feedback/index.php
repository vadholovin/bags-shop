...
$form['form-1'] = array(
	...
	'cfg' => array(
		...
		'title' => 'Перезвоните, пожалуйста',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'noreply@email.com',
		'from_name' => 'noreply',
		'to_email' => 'leodoro-opt@yandex.ru',
		'to_name' => 'noreply',
		'geoip' => false,
		'referer' => true,
		'type' => 'plain',
		...
		'okay' => 'Мы свяжемся с Вами в ближайшее время',
...
$form['form-2'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Заявка на каталог',
		'title' => 'Вышлите, пожалуйста, каталог',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'email',
		'from_name' => 'name',
		...
		'antispam' => 'email77',
		'antispamjs' => 'address77',
		'okay' => 'Ваша заявка отправлена. Высылаем каталог на Ваш почтовый ящик',
		'fuck' => 'ПРОИЗОШЛА ОШИБКА',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal-textbox',
		'usepresuf' => false
